...
export const users = sqliteTable('users', {
  ...
  notifyReStocked: integer('notify_re_stocked', { mode: 'boolean' }).notNull().default(true),
  notifyStockChange: integer('notify_stock_change', { mode: 'boolean' }).notNull().default(true),
  notifySoldOut: integer('notify_sold_out', { mode: 'boolean' }).notNull().default(true),
